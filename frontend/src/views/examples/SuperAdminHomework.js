...
const SuperAdminHomework = () => {
    ...
    useEffect(() => {
        axios
            .get("https://quranumaracademy.onrender.com/api/users", {
    ...
    useEffect(() => {
        if (selectedTeacher) {
            axios
                .get(`https://quranumaracademy.onrender.com/api/users/assigned-students/${selectedTeacher}`, {
                    headers: { Authorization: `Bearer ${token}` },
                })
                .then((response) => {
    ...
    const fetchHomework = async () => {
        try {
            const response = await axios.get("https://quranumaracademy.onrender.com/api/homework", {
                headers: { Authorization: `Bearer ${token}` },
            });
    ...
    const handleSaveHomework = async () => {
        try {
            ...
            if (editingHomeworkId) {
                // Update Homework
                await axios.put(`https://quranumaracademy.onrender.com/api/homework/update/${editingHomeworkId}`, homeworkPayload, {
                    headers: { Authorization: `Bearer ${token}` },
                });
                ...
                // Assign New Homework
                await axios.post("https://quranumaracademy.onrender.com/api/homework/assign", homeworkPayload, {
                    headers: { Authorization: `Bearer ${token}` },
                });
