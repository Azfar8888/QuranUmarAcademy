...
const SuperAdminHomework = () => {
    ...
    useEffect(() => {
        if (selectedTeacher) {
            axios
                .get(`${process.env.REACT_APP_API_URL}/api/users/assigned-students/${selectedTeacher}`, {
                    headers: { Authorization: `Bearer ${token}` },
                })
                .then((response) => {
    ...
    const fetchHomework = async () => {
        try {
            const response = await axios.get(`${process.env.REACT_APP_API_URL}/api/homework`, {
                headers: { Authorization: `Bearer ${token}` },
            });
    ...
    const handleSaveHomework = async () => {
        try {
            ...
            if (editingHomeworkId) {
                // Update Homework
                await axios.put(`${process.env.REACT_APP_API_URL}/api/homework/update/${editingHomeworkId}`, homeworkPayload, {
                    headers: { Authorization: `Bearer ${token}` },
                });
                ...
                // Assign New Homework
                await axios.post(`${process.env.REACT_APP_API_URL}/api/homework/assign`, homeworkPayload, {
                    headers: { Authorization: `Bearer ${token}` },
                });
